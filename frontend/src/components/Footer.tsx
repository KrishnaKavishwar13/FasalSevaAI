    ...
    <footer className="mt-24 border-t border-border/60 bg-muted/30">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6">
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2 max-w-sm">
            ...
            <form
              ...
              onSubmit={(e) => {
                e.preventDefault();
                toast.success(t("footer_subscribed_toast", "Subscribed"));
              }}
            >
              <Input
                type="email"
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              <li className="flex items-center gap-2">
                <Phone className="h-4 w-4" /> +91 9111946697
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4" /> hello@fasalseva.ai
              </li>
              <li className="flex items-center gap-2">
                <MapPin className="h-4 w-4" /> Indore, Madhya Pradesh
              </li>
              <li className="text-xs">
                {t("footer_languages_available", "Available in English & हिंदी")}
              </li>
            </ul>
        ...
        <div className="mt-10 flex flex-col justify-between gap-4 border-t border-border/60 pt-6 text-xs text-muted-foreground md:flex-row">
          <p>
            © {new Date().getFullYear()} FasalSeva AI.{" "}
            {t("footer_all_rights_reserved", "All rights reserved.")}
          </p>
