    ...
    <div className="mx-auto max-w-6xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Monitor bookings, capacity and facility visibility from one place.
        </p>
      </div>
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="p-5">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-muted-foreground">Registered Storage</p>
              <p className="text-2xl font-semibold">{storage.length}</p>
            </div>
        ...
        <Card className="p-5">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-muted-foreground">Live Capacity</p>
              <p className="text-2xl font-semibold">{storage[0]?.available_tons ?? 0} tons</p>
            </div>
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Badge variant="outline">
                    {facility.available_tons}/{facility.capacity_tons} tons free
                  </Badge>
                </div>
              </div>
            ))
