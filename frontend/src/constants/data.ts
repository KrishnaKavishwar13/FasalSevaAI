...
export const SCHEMES: Scheme[] = [
  {
    ...
    description:
      "A comprehensive package for creating modern infrastructure and efficient supply-chain management from farm gate to retail.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Crop insurance protecting against yield loss due to non-preventable natural risks — drought, flood, pest attack, and post-harvest losses.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Capital subsidy under the National Horticulture Mission for cold storage units, ripening chambers, and refrigerated transport.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Price stabilization and value-chain development for perishable produce to prevent distress selling.",
    benefits: [
